...
public class TestStudentArrayList {
	...
	public static void main(String[] args) {
		...
		StudentArrayList students = new StudentArrayList(num);
		System.out.println();
		...
		System.out.println(highest.getName() + " who has the highest GPA " + df.format(highest.getGPA()) + " is from major "+df.format(highest.getGPA()) + ".");
		System.out.println(lowest.getName() + " who has the lowest GPA " + df.format(lowest.getGPA()) + " is from major"+ highest.getMajor().toString() + ".");
		...
		if (students.remove(name)){
			System.out.println("successful removed" + name);
		}
		else {
			System.out.println("unable to remove" + name);
		}
